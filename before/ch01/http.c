...
int http_get(int connection, const char *path, const char *host, const char *proxy_host,
...
bool parse_proxy_param(char *proxy_spec, char **proxy_host, int *proxy_port, char **proxy_user, char **proxy_password) {
...
int main(int argc, char *argv[]) {
    ...
    printf("Connecting to host '%s', path: '%s'\n", host, path);
